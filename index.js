...
let output;
try {
    let result2 = exec.execSync('./glualint --config=' + __dirname + '/dependencies/glualint.json ' + process.env.GITHUB_WORKSPACE + core.getInput('directory'), { cwd: __dirname + '/dependencies' });
